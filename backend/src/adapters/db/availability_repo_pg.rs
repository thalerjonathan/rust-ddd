...
use crate::domain::{aggregates::{fixture::FixtureId, fixture::Fixture, referee::Referee}, repositories::availability_repo::AvailabilityRepository};
...
impl AvailabilityRepository for AvailabilityRepositoryPg {
    ...
    async fn get_availabilities_for_referee(&self, referee: &Referee, tx_ctx: &mut Self::TxCtx) -> Result<Vec<FixtureId>, Self::Error> {
        ...
        Ok(availabilities.into_iter().map(|a| a.fixture_id.into()).collect())
    }
