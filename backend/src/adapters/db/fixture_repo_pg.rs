...
use crate::domain::{
    aggregates::{
        fixture::{Fixture, FixtureId, FixtureStatus}, referee::Referee, team::{Team, TeamId}, venue::{Venue, VenueId}
    },
...
impl From<FixtureDb> for Fixture {
    fn from(fixture: FixtureDb) -> Self {
        Fixture::from_id(
            ...
            fixture.first_referee_id.map(|id| Referee::from_id(id.into(), fixture.first_referee_name.expect("first_referee_name is required"), fixture.first_referee_club.expect("first_referee_club is required"))),
            fixture.second_referee_id.map(|id| Referee::from_id(id.into(), fixture.second_referee_name.expect("second_referee_name is required"), fixture.second_referee_club.expect("second_referee_club is required")))   ,
        )
    }
}
