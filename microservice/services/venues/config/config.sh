...
export DB_URL="postgres://postgres:postgres@localhost:5434/venues?application_name=rustddd&options=-c search_path%3Drustddd"
...
export KAFKA_CONSUMER_GROUP='venues'
