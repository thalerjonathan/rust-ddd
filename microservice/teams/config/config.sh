...
export DB_URL="postgres://postgres:postgres@localhost:5435/teams?application_name=rustddd&options=-c search_path%3Drustddd"
...
export KAFKA_CONSUMER_GROUP='teams'
