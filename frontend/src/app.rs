use crate::components::{
    availabilities::Availabilities, fixture_list::FixtureList, home::Home, referee_details::RefereeDetails, referee_list::RefereeList, team_details::TeamDetails, team_list::TeamList, venue_details::VenueDetails, venue_list::VenueList
};
use leptos::*;
use leptos_router::*;
